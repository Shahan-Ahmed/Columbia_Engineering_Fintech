...
#This create html input field which will accept the sender info
sender_input = st.text_input("Sender") 

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
#This create html input field which will acceptethe receivers info
receiver_input = st.text_input("Receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
#This create html input field which will accept the amount info
